      ...
      <div className='recommendations'>
        ...
        <div className="row justify-content-center bg-black" style={{ overflowY: "scroll", maxHeight: "80vh" }}>
          ...
          {datas.map((movie, index) => (
            ...
            <div className='col-2 recoMovie' key={index} style={{width:"22vw", height:"50vh" }}>
              <Link to={"/movie/" + movie.id}>
                <div className='movieCard' style={{backgroundImage: `url(${getImage(movie.poster_path)})`, backgroundSize:"cover", width:"17vw", height:"40vh" }}>
                </div>
              </Link>
            </div>
          ))}
